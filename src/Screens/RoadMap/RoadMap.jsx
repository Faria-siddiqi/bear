          ...
          <div className={styles.road_map_content}>
            ...
            <div>
              <p>
                ...
                wellness into the metaverse. We want our holders to be proud of
                putting our title in their bio.
              </p>
            </div>
            <div className={styles.circle}></div>
            <div>
            ...
            <div>
              <p>
                ...
                physical/online clinics for those struggling with health issues
                and to create a community that has the resource to guide the
                youth. A portion of the secondary sales will be put into the
                foundation.
              </p>
            </div>
            <div className={styles.circle}></div>
            ...
            <div>
              <p>
                We are searching for land to build the very Health clinic in the
                metaverse. Sandbox VR, Decentraland, Cryptovoxels, and Somnium
                Space are a few platforms we consider.
              </p>
              <p>
                We are searching for land to build the very Health clinic in the
                metaverse. Sandbox VR, Decentraland, Cryptovoxels, and Somnium
              ...
              <p>
                We will host events that allow holders to network and build new
                relationships and host monthly health workshops. And, of course,
                each holder will get their unique 3D Lonely Bear in the
                metaverse.
              </p>
            </div>
          </div>
